...
## How to Report
Send an email to: Carterperez@certgames.com

- A description of the vulnerability
- Steps to reproduce the issue
- Potential impact
- Any suggested fixes (optional) Please do not open public issues for security vulnerabilities.
## Response Timeline
...
- For legal security research and learning Misuse of these tools for unauthorized access or malicious purposes is prohibited and may be illegal.
## Disclaimer
